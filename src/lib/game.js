export const game = 
{
	...
	feedback: [
		...
		{ id: 6, value: 3.0, text: "You are engaging in some activities and displaying attitudes that are strongly related to happiness and wellbeing but could significantly improve your wellbeing by making a few changes. Consider how you might do more of the following: pursue meaning as well as pleasure, focus on gratitude (maybe even keeping a gratitude journal), show kindness to others, find purposeful work, laugh often, spend time with pets, maintain relationships with family and friends (especially the happy, optimistic ones), share experiences with loved ones instead of focusing on accruing material goods, spend time in nature, keep an optimistic outlook, set aside time for daily mindfulness, pursuing activities or hobbies that you enjoy, limit screen time, and engage in self-care such eating a healthy diet, making sure that you fit in time for daily exercise or movement, and getting plenty of high quality sleep." },
		{ id: 7, value: 3.5, text: "You are engaging in many activities and displaying many attitudes that are strongly related to happiness and wellbeing! You can maintain or even improve this by pursuing meaning as well as pleasure, focusing on gratitude (maybe even keeping a gratitude journal), showing kindness to others, finding purposeful work, laugh often, spend time with pets, maintaining relationships with family and friends (especially the happy, optimistic ones), sharing experiences with loved ones instead of focusing on accruing material goods, spending time in nature, keeping an optimistic outlook, setting aside time for daily mindfulness, pursuing activities or hobbies that you enjoy, limiting screen time, and engaging in self-care such eating a healthy diet, making sure that you fit in time for daily exercise or movement, and getting plenty of high quality sleep." },
		{ id: 8, value: 4.0, text: "You are making the most out of life and making choices that lead to high levels of satisfaction and joy. You can maintain this by pursuing meaning as well as pleasure, focusing on gratitude (maybe even keeping a gratitude journal), showing kindness to others, finding purposeful work, laugh often, spend time with pets, maintaining relationships with family and friends (especially the happy, optimistic ones), sharing experiences with loved ones instead of focusing on accruing material goods, spending time in nature, keeping an optimistic outlook, setting aside time for daily mindfulness, pursuing activities or hobbies that you enjoy, limiting screen time, and engaging in self-care such eating a healthy diet, making sure that you fit in time for daily exercise or movement, and getting plenty of high quality sleep. Remember that happiness is an emotion, not a constant state of being. It is natural to fluctuate in and out of feeling happy throughout a lifetime." },
	],
	images_feedback: [
		{ id: 1, value: 1.2, text: "You seem to enjoy a lot of activities that bring you pleasure. That's great but these activities aren't necessarily likely to bring lasting happiness. You might consider spending more time focused on activities that research has show to increase wellbeing. This might include spending time in nature, volunteering, talking with friends or family, and having a pet." },
		{ id: 2, value: 2.8, text: "You selected a combination of activities that bring meaning as well as pleasure.  Because research shows that both are important to happiness, you are demonstrating a positive approach to the way you spend your time. Continuing to maintain a good balance is likely to help maximize your wellbeing." },
		{ id: 3, value: 4.0, text: "Almost all of the activities you selected are eudaimonic. This means that you prioritize meaning, which is a great thing. It is important to remember, however, that research shows that pleasure is also important to wellbeing.You might try indulging in more fun or thrilling activities occasionally as a way to maximize your happiness." },
	],
	questions: [
		{
			id: 1,
		...
		},
		{
			...
			options: [
				...
				{ id: 3, label: "", score: 1, url: "https://images.unsplash.com/photo-1577896850561-dc005e5b5689?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 4, label: "", score: 1, url: "https://images.unsplash.com/photo-1553729784-e91953dec042?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 5, label: "", score: 1, url: "https://images.unsplash.com/photo-1576737064520-f45d313d17ff?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 6, label: "", score: 1, url: "https://images.unsplash.com/photo-1568454537842-d933259bb258?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 7, label: "", score: 1, url: "https://images.unsplash.com/photo-1538599462720-b466e1ce73d3?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 8, label: "", score: 1, url: "https://images.unsplash.com/photo-1530541930197-ff16ac917b0e?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 9, label: "", score: 1, url: "https://images.unsplash.com/photo-1559027615-cd4628902d4a?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 10, label: "", score: 1, url: "https://images.unsplash.com/photo-1607962837359-5e7e89f86776?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 11, label: "", score: 1, url: "https://images.unsplash.com/photo-1504194569341-48a2e831a3a7?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 12, label: "", score: 1, url: "https://images.unsplash.com/photo-1595314544137-1b106b06e2c1?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 13, label: "", score: 0, url: "https://images.unsplash.com/photo-1553729459-efe14ef6055d?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 15, label: "", score: 0, url: "https://images.unsplash.com/photo-1646318754907-dc7c0d236a97?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 16, label: "", score: 0, url: "https://images.unsplash.com/photo-1511919884226-fd3cad34687c?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 17, label: "", score: 0, url: "https://images.unsplash.com/photo-1622549037543-49cf1ca0babc?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 18, label: "", score: 0, url: "https://images.unsplash.com/photo-1483985988355-763728e1935b?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 19, label: "", score: 0, url: "https://images.unsplash.com/photo-1575037614876-c38a4d44f5b8?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 20, label: "", score: 0, url: "https://images.unsplash.com/photo-1514820720301-4c4790309f46?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 21, label: "", score: 0, url: "https://images.unsplash.com/photo-1600861194942-f883de0dfe96?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 22, label: "", score: 0, url: "https://images.unsplash.com/photo-1596451190630-186aff535bf2?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=300&ixlib=rb-4.0.3&q=80&w=300" },
				{ id: 23, label: "", score: 0, url: "https://cdn.outsideonline.com/wp-content/uploads/2015/05/21/sunshine-superman-jean-carl-boenish_h.jpg?crop=4:3&width=300&enable=upscale&quality=100" },
		...
		},
		{
			...
			questions: [
				...
				{ id: 3, sign: 1, q: "These activities helped me connect information from this class to prior information from other classes." },
				{ id: 4, sign: 1, q: "These activities helped me establish a personal connection with the material." },
				{ id: 5, sign: 1, q: "These activities increased my motivation to learn." },
				{ id: 6, sign: 1, q: "Receiving frequent and timely feedback helped me correct misconceptions and develop a deeper understanding of course material." },
				{ id: 7, sign: 1, q: "Regular interaction with the instructor contributed to the creation of a sense of community in the classroom." },
				{ id: 8, sign: 1, q: "Regular interaction with the TA contributed to the creation of a sense of community in the classroom." },
				{ id: 9, sign: 1, q: "Regular interaction with the PLA contributed to the creation of a sense of community in the classroom." },
				{ id: 10, sign: 1, q: "I believe that my grade in this course would have been lower without active learning activities." },
				{ id: 11, sign: 1, q: "Sitting in pods or groups was conducive to creating a classroom community and improved the learning environment." },
			],
			options: [
				{ id: 1, option: "Strongly Disagree", score: 0},
				{ id: 2, option: "Disagree", score: 0},
				{ id: 3, option: "No Impact", score: 0},
				{ id: 4, option: "Agree", score: 0},
				{ id: 5, option: "Strongly Agree", score: 0}
			],
			weight: 1,
			multiple: true,
			type: "radio",
